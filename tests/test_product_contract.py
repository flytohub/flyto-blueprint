...
BLUEPRINT_PACKAGE = {
    ...
    "layer": "procedure_memory",
    "layer_order": 2,
    "owns": [
        "reusable procedure learning and scoring",
        "procedure expansion and compatibility",
        "procedure outcome history",
    ],
    "does_not_own": [
...
def test_blueprint_product_contract_is_exact() -> None:
    assert _load_contract() == {**COMMON, "package": BLUEPRINT_PACKAGE}


def test_readme_presents_the_shared_contract_and_blueprint_role() -> None:
